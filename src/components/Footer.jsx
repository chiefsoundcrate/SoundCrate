  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundSize: "110%", // slight zoom
      }}
    >
      {/* Soft blur overlay */}
      ...
      <div className="container relative z-10">
        <div className="max-w-2xl mx-auto text-center px-4"> {/* expanded width & padding */}
          <h1
            ...
            style={{ fontFamily: "Inter", fontSize: "50px" }}
          >
            Join The Waitlist
          </h1>
          <p
          ...
          <div className="flex justify-center mb-2 mt-7">
            <a
              href="/#hero"
              className="bg-[#29f2c0] text-black py-3.5 px-3 rounded-md hover:bg-[#1fd1a4] transition-all text-md h-[50px] text-center"
              style={{ fontFamily: "Inter" }}
            >
              Join the Waitlist
            </a>
